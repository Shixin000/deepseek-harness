...
| `event:diagram/saved` | event | `bfa9b4ef71ecd0a138acdd82088d8923929dd2a004aa48a7426e0165096006ef` | [`event:diagram/saved`](#persistence-type-eventdiagramsaved) |
...
<a id="persistence-type-diagramsaved"></a>
...
| Property | Presence | Type |
|---|---|---|
| `data` | required | [`event:diagram/saved.data`](#persistence-type-eventdiagramsaveddata) |
| `ignorable` | optional | `true` |
| `seq` | required | `number` |
| `time` | required | `number` |
| `type` | required | `"diagram/saved"` |

<a id="persistence-type-eventdiagramsaveddata"></a>

### `event:diagram/saved.data`
