...
export function clientBundle(
  ...
  return ({ env }) => {
    ...
    const client = clientConfig(id, clientEntry, options.client, options.clientBanner)
...
function clientConfig(id: string, entry: string, overrides: UserConfig = {}, clientBanner?: (fileName: string) => string | undefined): UserConfig {
