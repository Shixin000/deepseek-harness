...
| `@deepseek-ai/dsh-client-ui-diagram` | no | Web diagram tool card: inline read-only SVG rendering of .excalidraw diagrams produced by the diagram tool |
| `@deepseek-ai/dsh-client-ui-diagram-canvas` | no | Web interactive Excalidraw whiteboard panel: open and edit .excalidraw diagrams produced by the diagram tool |
...
| Package | Config | Description |
|---|---|---|
| `@deepseek-ai/dsh-diagram` | yes | Model-facing diagram tool that writes Excalidraw-format files from a validated shape spec |
