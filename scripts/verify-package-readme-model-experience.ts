...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  'packages/client/ui-diagram': { kind: 'none', reason: 'Browser-side diagram card; renders the persisted diagram projection without changing model context.' },
  'packages/client/ui-diagram-canvas': { kind: 'none', reason: 'Browser-side whiteboard panel; the save bridge calls the Host Remote without changing model context.' },
